                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0" style="color: #cbd5e0;">
                            ...
                            <tr>
                                ...
                                <th class="border-0 text-center">Öne Çıkan</th>
                                <th class="border-0">Oluşturma</th>
                                ...
                                <tr style="border-bottom: 1px solid #2d3244;">
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="text-white font-weight-bold mb-0">{{ $project->name }}</div>
                                                <div class="text-muted" style="font-size: 0.75rem;">
                                                    <i class="fas fa-link mr-1"
                                                       style="font-size: 0.6rem;"></i>{{ $project->slug }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                            ...
                            <span class="badge border border-secondary text-light px-2 py-1"
                                ...
                                Kat-{{ $project->category_id }}
                            </span>
                                    </td>
                                    <td class="align-middle text-center">
                                        @if($project->isFeatured)
                                            <span class="badge px-2 py-1"
                                                  style="background-color: rgba(40, 167, 69, 0.2); color: #2ecc71; border-radius: 6px;">
                                    <i class="fas fa-check-circle mr-1 small"></i> Aktif
                                </span>
                                        @else
                                            <span class="badge px-2 py-1"
                                                  style="background-color: rgba(108, 117, 125, 0.2); color: #a0aec0; border-radius: 6px;">
                                    <i class="fas fa-times-circle mr-1 small"></i> Pasif
                                </span>
                                        @endif
                                    </td>
                                    <td class="align-middle">
                                        <div class="small text-white-50"><i
                                                class="far fa-calendar-alt mr-1"></i> {{ \Carbon\Carbon::parse($project->created_at)->translatedFormat('d M Y') }}
                                        </div>
                                        <div class="text-muted"
                                             style="font-size: 0.7rem; margin-left: 17px;">{{ \Carbon\Carbon::parse($project->created_at)->format('H:i') }}</div>
                                    </td>
